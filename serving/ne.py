...
def create_engine():
    ...
    redis_storage_w = RedisStorage(Redis(host='localhost', port=6379, db=3))

    # Dimension of our vector space
    dimension = 100

    rbp = get_hash_config(redis_storage_w, "WordHash")
    ...
    engine_word = Engine(dimension, distance=CosineSim(), 
                lshashes=[rbp], storage=redis_storage_w)
    return engine_doc, engine_word
